<?php
    ...
    $tempurl = explode('/', $url);
    $tempurl[count($tempurl)-1] = "api/user_api.php";
    $url = implode("/", $tempurl);
    ...
    $url = "https://".$_SERVER['HTTP_HOST'].$_SERVER['REQUEST_URI'];
    $tempurl = explode('/', $url);
    $tempurl[count($tempurl)-1] = "api/route_api.php";
    $url = implode("/", $tempurl);
    curl_setopt($ch, CURLOPT_URL, $url);
    curl_setopt($ch, CURLOPT_RETURNTRANSFER, true);
    curl_setopt($ch, CURLOPT_FOLLOWLOCATION, false);
...
<html>
    ...
    <body>
        <nav class="navbar">
            ...
            <div class="nav-links">
                <a href="front_page.php" class="nav-item active">Home</a>
                <a href="create_route.php" class="nav-item">Create Route</a>
