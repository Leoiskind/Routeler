...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="create_route.css">
  ...
  <body>
    <nav class="navbar">
      ...
      <div class="nav-links">
        ...
        <a href="create_route.html" class="nav-item active">Create Route</a>
    ...
    <div class="info-box">
      ...
      <form id="route-form" action="route_api.php" method="POST" class="input-container">
